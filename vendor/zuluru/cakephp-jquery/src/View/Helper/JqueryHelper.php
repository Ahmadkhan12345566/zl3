...
class JqueryHelper extends Helper {
	 ...
	 * @return string
	 */
	public function ajaxButton(string $text, array $data = [], array $button_options = []): string {
	 ...
	 * @return string
	 */
	public function ajaxInput(string $input, array $data = [], array $input_options = []): string {
	 ...
	 * @return string
	 */
	public function ajaxLink(string $text, array $data = [], array $link_options = []): string {
	...
	public function autocompleteInput(string $input, string $id, array $data): string {
		$input_options = [
			'type' => 'text',
	 ...
	 * @return string
	 */
	public function inPlaceWidget(string $text, array $data = [], array $widget_options = [], bool $dropdown_icon = true, array $ajax_data = null): string {
	 ...
	 * @return string
	 */
	public function inPlaceWidgetOptions(array $options, array $data = [], string $prompt = null): string {
		if ($prompt) {
	 ...
	 * @return string
	 */
	public function moreWidget(array $data, array $actions, string $text = null, array $widget_options = [], bool $dropdown_icon = true): string {
		if (empty($actions)) {
			return '';
		}
	...
	public function selectAll(string $selector, string $text = null, array $classes = []): string {
		if ($text) {
	 ...
	 * @return string
	 */
	public function toggleInput(string $input, array $input_options = [], array $selector_options = []): string {
	 ...
	 */
	public function toggleLink(string $text, $selector, array $link_options = [], array $toggle_options = [], string $target = '#'): string {
	...
	public function toggleLinkPair(string $a_text, string $a_class, string $b_text, string $b_class, array $link_options = []): string {
